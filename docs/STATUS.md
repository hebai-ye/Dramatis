...
Dramatis 是一个多角色扮演酒馆，兼容 SillyTavern 资产格式。**P0（9 项）全部完成，P1 完成 7/11；界面改版三批（A/B/C）全部完成；P1-10 真模型验证已跑两轮**，241 个测试通过。

**下一批做什么看 [TASKS.md](./TASKS.md)**：格式遵守率、意图先行调度、50 回合长跑、成本统计完整化。

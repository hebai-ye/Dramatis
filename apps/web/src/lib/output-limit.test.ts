...
describe('单角色本轮生成上限', () => {
  ...
  it('推理模型保留推理与最终正文的空间', () => {
    ...
    expect(replyTokenLimit('deepseek-flash', 4096)).toBeUndefined();
    expect(replyTokenLimit('deepseek-v4-pro', 4096)).toBeUndefined();
    expect(replyTokenLimit('deepseek-v4-flash', 4096)).toBeUndefined();

...
> 账户重构 A1/A3/A4 已上线：网页构建 index-G45-08au.js，公网反代核验 404 正常；回滚点 /var/www/dramatis.bak-20260921-223328。

**27a–27e 已完成**：记忆合并、附件、按需展开、可回滚影响与面板收尾都落地。

**账户重构（A1/A3/A4 已落）**：账户名、账户 ID 与内部数据库彻底分层；Persona
移到左栏“我的身份”，并改成对话级选择；迁移 v10 把旧世界身份复制到已有对话。
A1 真机 8/8，A3 真机 5/5，A4 双对话隔离真机 6/6。

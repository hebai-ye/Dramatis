...
> 就能接着干。当前测试 **549 个全绿**，类型检查 / lint / 构建全绿。
...
> 顺序 27b–27d 已上线：网页构建 index-Ce3dI01j.js，公网反代核验 404 正常；回滚点 /var/www/dramatis.bak-20260921-214212。

**下一步第一件事（27e）**：
记忆面板里显示「印象 → 它的来源原文」这条链子，以及附件预览。

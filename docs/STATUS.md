...
> 就能接着干。当前测试 **551 个全绿**，类型检查 / lint / 构建全绿。
...
> 账户重构 A1–A8 已上线：网页构建 index-BV5zll7I.js，同步服务端已更新；公网反代核验 404 正常。网页回滚点 /var/www/dramatis.bak-20260921-225414，服务端回滚点 /opt/dramatis-sync/dist.bak-20260921-225356。

**27a–27e 已完成**：记忆合并、附件、按需展开、可回滚影响与面板收尾都落地。

**账户重构（A1/A3–A8 已落）**：账户名、ID 与内部数据库分层；Persona 左栏管理、
对话级选择、副对话工具与彻底删除；模型配置和 API Key 密文随账户同步。
A1 8/8，A3 5/5，A4 6/6，A5/A8 各 4/4，A6/A7 6/6。
